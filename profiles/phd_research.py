...
PROFILE_DESCRIPTION = "Geometric Deep Learning · Topological Data Analysis · Topological Signal Processing"

# ── 연구 주제 (시맨틱 유사도 필터링 기준) ────────────────────────────────────────
TEAM_RESEARCH_TOPICS = [
    ...
    "Vietoris-Rips and Cech complexes for shape analysis",
